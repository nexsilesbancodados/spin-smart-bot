  ...
  return (
    <div className="min-h-screen bg-gradient-casino flex flex-col">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary/2 rounded-full blur-[150px]" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-accent/2 rounded-full blur-[150px]" />
      </div>
