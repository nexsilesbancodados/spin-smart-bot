import { RefreshCw, TrendingUp, Target, Crosshair, Activity, Zap } from 'lucide-react';
        ...
        {predStats.total >= 5 && (() => {
          ...
          return (
            <motion.span
              ...
              className={`text-[8px] font-display font-bold px-2.5 py-1 rounded-xl border tracking-wider flex items-center gap-1 ${
