...
import { buildWheelDeepPatterns } from "./wheelDeepPatterns";
import { buildDocumentedPatterns } from "./documentedPatterns";
...
export const getPatternBank = (): PatternRule[] => {
  ...
  CACHED_BANK = [
    ...
    ...buildWheelDeepPatterns(),
    ...buildDocumentedPatterns(),
  ];
  return CACHED_BANK;
};
